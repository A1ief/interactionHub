...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li class="active"><a href=""><i class='bx bxs-user-detail'></i>Customer</a></li>
    ...
    <div class="content">
        ...
        <main>
            ...
            <!-- <a href="customer_form.php" style="padding: 8px 15px; background-color: #007bff; color: white; text-decoration: none; border-radius: 5px;margin-top:1000px;">Add New Customer</a> -->
            <table>
                <thead>
                    <tr>
                        <th>ID</th>
