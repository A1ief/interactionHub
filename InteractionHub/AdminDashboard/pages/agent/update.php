...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $sql = "UPDATE agent SET name = :name, email = :email, phone = :phone WHERE id = :id";
        $stmt = $pdo->prepare($sql);
        $stmt->bindParam(':id', $id);
        ...
        <main>
            ...
            <div>
                ...
                <form action="update.php" method="post" id="formUpdate" class="form">
                    <input type="hidden" name="id" value="<?= htmlspecialchars($agents['id']) ?>">
                    <label for="name">Name:</label>
                    <input type="text" name="name" id="name" value="<?= htmlspecialchars($agents['name']) ?>" required><br>

                    <label for="email">Email:</label>
                    <input type="email" name="email" id="email" value="<?= htmlspecialchars($agents['email']) ?>" required><br>

                    <label for="phone">Phone:</label>
                    <input type="text" name="phone" id="phone" value="<?= htmlspecialchars($agents['phone']) ?>" required><br>
